...
class Image(models.Model):
    ...
    image_webp = models.ImageField(_('ссылка на обработанную картинку в формате webp'))
    image_crop = models.ImageField(_('ссылка на обработанную и сжатую до 300*300px картинку в формате webp'))
    image_base64 = models.TextField(_('загруженная картинка в base64'), null=True, blank=True)
